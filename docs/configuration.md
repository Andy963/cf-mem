...
| `ADMIN_ACCESS_TEAM_DOMAIN` | 无 | 可选，固定 Cloudflare Access team domain，例如 `https://team.cloudflareaccess.com` |
| `ADMIN_ACCESS_AUD` | 无 | 可选，固定 Access Application AUD tag；建议生产环境配置 |
...
# Recommended for production pinning:
